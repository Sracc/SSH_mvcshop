	...
	public String dayin(){
		...
		String realPathImage = application.getRealPath("/upload_image");
		 try   { 
            ...
            Label label1  =   new  Label( 1 ,  0 ,  " 头像 " ,wcfN); sheet.addCell(label1); 
            sheet.setColumnView(2, cellView);
            Label label2  =   new  Label( 2 ,  0 ,  " 姓名 " ,wcfN); sheet.addCell(label2); 
            sheet.setColumnView(3, cellView);
            Label label3  =   new  Label( 3 ,  0 ,  " 性别 " ,wcfN); sheet.addCell(label3); 
            sheet.setColumnView(4, cellView);
            Label label4  =   new  Label( 4 ,  0 ,  " 联系电话 " ,wcfN); sheet.addCell(label4); 
            sheet.setColumnView(5, cellView);
            Label label5  =   new  Label( 5 ,  0 ,  " 住址 " ,wcfN); sheet.addCell(label5); 
            sheet.setColumnView(6, cellView);
            Label label6  =   new  Label( 6 ,  0 ,  " 邮箱 " ,wcfN); sheet.addCell(label6); 
            sheet.setColumnView(7, cellView);
            Label label7  =   new  Label( 7 ,  0 ,  " 登录账号 " ,wcfN); sheet.addCell(label7); 
            
            int i = 0;
            for(Member e:members){
            	i+=1;
            	jxl.write.Number llabel0  =   new  jxl.write.Number( 0 ,  i ,  e.getId() ,wcfN); sheet.addCell(llabel0); 
            	File file=new File(realPathImage+"/"+e.getImg()); 
            	jxl.write.WritableImage llabel1  =   new  jxl.write.WritableImage( 1 ,  i ,1,1,  file ); sheet.addImage(llabel1); 
            	Label llabel2  =   new  Label( 2 ,  i ,  e.getName() ,wcfN); sheet.addCell(llabel2); 
            	Label llabel3  =   new  Label( 3 ,  i ,  e.getSex() ,wcfN); sheet.addCell(llabel3); 
            	Label llabel4  =   new  Label( 4 ,  i ,  e.getTel() ,wcfN); sheet.addCell(llabel4); 
            	Label llabel5  =   new  Label( 5 ,  i ,  e.getAddress() ,wcfN); sheet.addCell(llabel5); 
            	Label llabel6  =   new  Label( 6 ,  i ,  e.getEmail() ,wcfN); sheet.addCell(llabel6); 
            	Label llabel7  =   new  Label( 7 ,  i ,  e.getUsers().getUsername() ,wcfN); sheet.addCell(llabel7); 
            }
