...
<div class="dialog-body" style="overflow-y: scroll;height:450px"> 
...
<div class="dialog-foot"> <button class="button bg-green" onclick="$('form[class=registform]').submit()" >立即注册</button> <button class="button dialog-close">取消</button> </div> 
</div> </div>
...
<div id="registm" class="registm"> <div class="dialog" style="overflow-y: scroll;height:450px"> 
<div class="dialog-head"><span class="close rotate-hover"></span>
<strong>注册</strong> 
</div>
