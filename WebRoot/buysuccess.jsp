...
购买成功！<br/>
<button class="button bg-green" onclick="window.location.href='/'">继续购物</button>
<button class="button bg-green" onclick="window.location.href='site!member'">去会员中心查看</button>
</div>
</div>
